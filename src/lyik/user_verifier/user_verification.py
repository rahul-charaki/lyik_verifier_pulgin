...
import logging
from ..model.jobapplicationform import RootPersonalInfo
...
class UserVerification(VerifyHandlerSpec):
    @impl
    async def verify_handler(self, context:ContextModel, payload:RootPersonalInfo) -> VerifyHandlerResponseModel:
        """
